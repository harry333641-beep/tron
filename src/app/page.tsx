...
export default function Home() {
  ...
  return (
    <main className="min-h-dvh overflow-x-hidden bg-background text-foreground">
      ...
      <footer className="border-t-2 border-foreground bg-background"><div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10"><div><p className="font-black">波场能量购买与租赁</p><p className="mt-1 text-xs text-muted-foreground">按套餐转入 TRX · 到账后 1 小时内完成转账</p></div><Button type="button" onClick={() => window.open(telegramUrl, "_blank", "noopener,noreferrer")} className="gap-2 rounded-lg border-2 border-foreground bg-primary font-black text-primary-foreground shadow-[3px_3px_0_var(--foreground)]"><ExternalLink size={15} /> Telegram 客服</Button></div></footer>
    </main>
  );
}
